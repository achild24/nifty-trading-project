...
export const Portfolio = () => {
  ...
  const handleTrade = async (position, type) => {
    setError('');
    const quantity = Math.max(1, Number(quantities[position.symbol] || 1));
